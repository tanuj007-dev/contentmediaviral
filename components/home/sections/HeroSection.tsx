...
import arrowScribble from "@/public/Untitled design (52).png";
      ...
      <div className="relative z-10 flex w-full max-w-4xl flex-col items-center text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link
              href="#inquire"
              className="inline-block rounded-full bg-gradient-to-r from-purple-600 to-purple-500 px-10 py-4 font-semibold text-white shadow-[0_0_30px_rgba(147,51,234,0.35)] transition-shadow duration-300 hover:shadow-[0_0_50px_rgba(147,51,234,0.55)]"
            >
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link
              href="/portfolio"
              className="inline-block rounded-full border border-white/10 bg-white/5 px-10 py-4 font-semibold text-white backdrop-blur-md transition hover:border-purple-500/50"
            >
              View Portfolio
            </Link>
          </motion.div>
