...
export function ServiceRow({
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute right-14 top-1/2 z-10 -translate-y-1/2 scale-90 opacity-0 transition-all duration-300 ease-out group-hover:scale-100 group-hover:opacity-100 min-[969px]:right-[5.5rem]"
      >
