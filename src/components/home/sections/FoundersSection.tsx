...
const FOUNDERS = [
  ...
  ["f4 bg-gradient-to-br from-[var(--accent)] to-[#c084fc]", "Deepak Keewlani", "founder · corelex", "Documented his 24-day brand launch with high-converting scripts, custom storytelling voice, and full Instagram management with brand fonts and palette."],
] as const;
